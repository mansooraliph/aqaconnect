...
const PERMISSIONS: { key: string; module: string; description: string }[] = [
  ...
  { key: 'mobile_api.students.reports.access', module: 'mobile_api', description: 'Mobile app: Student Reports dashboard shortcut (admission-year-reports)' },
  ...
  { key: 'mobile_api.dashboard.header', module: 'mobile_api', description: 'Mobile app: Student Dashboard greeting header' },
  { key: 'mobile_api.dashboard.verse_of_day', module: 'mobile_api', description: 'Mobile app: Student Dashboard Verse of the Day card' },
  { key: 'mobile_api.dashboard.announcements', module: 'mobile_api', description: "Mobile app: Student Dashboard Announcements widget" },
  ...
  { key: 'mobile_api.attendance.access', module: 'mobile_api', description: 'Mobile app: own/employee attendance summaries and reports' },
  { key: 'mobile_api.attendance.approve', module: 'mobile_api', description: 'Mobile app: review and approve/reject pending clock-in requests' },
  { key: 'mobile_api.leaves.access', module: 'mobile_api', description: 'Mobile app: leave types, apply/cancel/my-leaves' },
...
const ROLES: {
  ...
  },
  {
    ...
    permissionKeys: [
      ...
      'mobile_api.student_leaves.approve',
  ...
  },
  {
    ...
    permissionKeys: [
      ...
      'mobile_api.dashboard.header',
      'mobile_api.dashboard.verse_of_day',
      'mobile_api.dashboard.announcements',
      'mobile_api.tab_attendance.access',
      'mobile_api.attendance.access',
    ],
  },
